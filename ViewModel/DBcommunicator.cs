...
namespace ViewModel
{
    class DBcommunicator
    {
        ...
        {
            dbConcection.AddProject(project.ProjectName, project.MinBudget, project.MaxBudget, project.StartDate, project.FinalDate);
        ...
        {
            dbConcection.ArchiveProject(project.ProjectName, project.MinBudget, project.MaxBudget, project.StartDate, project.FinalDate);
